...
dir_images          = '/tmp/images'
dir_annotations     = '/tmp/images_images_labeled'

label_map_path      = '/opt/models/research/object_detection/data/mscoco_label_map.pbtxt'

train_output        = '/tmp/train.record'
